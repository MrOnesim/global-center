...
const opportunities: Record<string, {
  ...
  'aide-menagere-premium': {
    ...
    amount: 'Sur devis',
    duration: 'Continue',
    image: '/images/pexels-aide-menagere-deux.jpg',
  ...
  'nounou-qualifiee-bilingue': {
    ...
    amount: 'Sur devis',
    duration: 'Continue',
    image: '/images/pexels-nounou-chambre.jpg',
  ...
  'cuisiniere-professionnelle': {
    ...
    amount: 'Sur devis',
    duration: 'Continue',
    image: '/images/pexels-cuisiniere.jpg',
  ...
  'chauffeur-prive': {
    ...
    amount: 'Sur devis',
    duration: 'Continue',
    image: '/images/pexels-chauffeur-conduite.jpg',
  ...
  'gardiennage-securite': {
    ...
    amount: 'Sur devis',
    duration: 'Continue',
    image: '/images/pexels-gardien.jpg',
